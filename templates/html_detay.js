...
<head>
    ...
    <title>Makale Detayı | Avukat Barış Hezer</title>
    <!-- Open Graph -->
    <meta property="og:type" content="article">
    <meta property="og:title" content="Makale Detayı | Avukat Barış Hezer">
    <meta property="og:description" content="Detaylı hukuki incelemeler ve yasal haklarınıza dair uzman yazısı.">
...
<body>
        ...
        <div style="max-width: 850px; margin: 0 auto; background: var(--white); padding: 3rem; border-radius: 8px; box-shadow: 0 10px 25px rgba(0,0,0,0.05); border-top: 4px solid var(--accent);">
            ...
            <article id="articleContent">
                <div style="display: flex; gap: 1rem; align-items: center; color: var(--text-muted); font-size: 0.9rem; margin-bottom: 1rem;">
                    ...
                    <span>&bull;</span>
                    <span><i class="fa-solid fa-user"></i> Av. Barış Hezer</span>
                </div>
    ...
    <footer>
        <p>&copy; 2026 Av. Barış Hezer. | <a href="kvkk.html"><i class="fa-solid fa-shield-halved"></i> KVKK</a></p>
    </footer>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', async () => {
            ...
            if (!id) {
                ...
                textEl.innerHTML = '<p>Makale ID belirtilmedi.</p>';
                return;
            }
            if (db[id]) {
                ...
                try {
                    ...
                    console.error(err);
                    titleEl.textContent = 'Makale Bulunamadı';
                    textEl.innerHTML = '<p>Aradığınız makale bulunamadı veya silinmiş olabilir.</p>';
                }
            }
        });
    </script>
